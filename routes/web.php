...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('movies/edit_movie/{id}', 'MoviesController@editMovie');
     Route::get('movies/subtitle/{id}', 'MoviesController@genSubtitle');
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('rss_feeds/edit/{id}', 'RssFeedController@edit');
        Route::get('rss_feeds/delete/{id}', 'RssFeedController@delete');
...
// Live Chat Public Widget Routes
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/messages', [ChatController::class, 'index'])->name('admin.chat.index');
