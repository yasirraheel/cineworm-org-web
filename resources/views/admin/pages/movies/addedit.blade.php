                        ...
                        <div class="card-box">
                            ...
                            @if (!getcong('tmdb_api_key'))
                                <div class="alert alert-danger">
                                    ...
                                    Please set TMDB API key <a href="{{ URL::to('admin/general_settings') }}#tmdbapi_id"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="imdb_id_title" id="imdb_id_title" value=""
                                            class="form-control" placeholder="Enter IMDb ID (e.g. tt1469304)"
                                            @if (!getcong('omdb_api_key')) disabled @endif>
                                        <small id="emailHelp"
                                            class="form-text text-muted">({{ trans('words.imdb_search_recommended') }})</small>
                                    </div>
                                    <div class="col-sm-2">
                                        <button type="submit" id="import_movie_btn"
                                            class="btn btn-primary waves-effect waves-light text-uppercase mt-1 pt-2 pb-2 pl-3 pr-3"
                                            @if (!getcong('omdb_api_key')) disabled @endif> {{ trans('words.fetch') }}
                                        </button>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="upcoming" id="upcoming">
                                                <option value="0" @if (isset($movie->upcoming) and $movie->upcoming == 0) selected @endif>
                                                    {{ trans('words.upcoming_no') }}</option>
                                                <option value="1" @if (isset($movie->upcoming) and $movie->upcoming == 1) selected @endif>
                                                    {{ trans('words.upcoming_yes') }}</option>
                                            </select>
                                            <small id="emailHelp" class="form-text text-muted">(Upcoming display only on
                                                Home page)</small>
                                        </div>
                                    ...
                                    <!--            <option value="Paid" @if (isset($movie->video_access) and $movie->video_access == 'Paid') selected @endif>-->
                                    <!--                {{ trans('words.paid') }}</option>-->
                                    <!--            <option value="Free" @if (isset($movie->video_access) and $movie->video_access == 'Free') selected @endif>-->
                                    <!--                {{ trans('words.free') }}</option>-->
                                    <!--        </select>-->
                                    <!--    </div>-->
                                            ...
                                            <select class="form-control select2" name="movie_language" id="movie_language">
                                                ...
                                                @foreach ($language_list as $language_data)
                                                    <option value="{{ $language_data->id }}"
                                                        @if (isset($movie->id) && $language_data->id == $movie->movie_lang_id) selected @endif>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="actors" id="actors"
                                                value="{{ isset($movie->actors) ? stripslashes($movie->actors) : old('actors') }}"
                                                class="form-control">
                                        </div>

                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Directors</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="director" id="director"
                                                value="{{ isset($movie->director) ? stripslashes($movie->director) : old('director') }}"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="actors_id[]" class="select2 select2-multiple"
                                                multiple="multiple" multiple id="actors_id"
                                                data-placeholder="Select Actors...">
                                                @foreach ($actor_list as $actor_data)
                                                    <option value="{{ $actor_data->id }}"
                                                        @if (isset($movie->id) && in_array($actor_data->id, explode(',', $movie->actor_id))) selected @endif>
                                                        {{ $actor_data->ad_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="select2 select2-multiple" name="director_id[]"
                                                id="director_id" multiple="multiple" multiple
                                                data-placeholder="Select Directors...">
                                                @foreach ($director_list as $director_data)
                                                    <option value="{{ $director_data->id }}"
                                                        @if (isset($movie->id) && in_array($director_data->id, explode(',', $movie->director_id))) selected @endif>
                                                        {{ $director_data->ad_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" id="imdb_rating" name="imdb_rating"
                                                    value="{{ isset($movie->imdb_rating) ? $movie->imdb_rating : old('imdb_rating') }}"
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" id="content_rating" name="content_rating"
                                                    value="{{ isset($movie->content_rating) ? $movie->content_rating : old('content_rating') }}"
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" id="datepicker-autoclose" name="release_date"
                                                    value="{{ isset($movie->release_date) ? date('m/d/Y', $movie->release_date) : old('release_date') }}"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="duration" id="duration"
                                                    value="{{ isset($movie->duration) ? $movie->duration : old('duration') }}"
                                                    class="form-control" placeholder="1h 35m 54s">
                                                <div class="input-group-append">
                                    ...
                                    @if (auth()->user()->usertype != 'Admin' and auth()->user()->usertype != 'Moderator')
                                        <div class="form-group row">
                                    ...
                                    @endif
                                    @if (auth()->user()->usertype == 'Admin' or auth()->user()->usertype == 'Moderator')
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">{{ trans('words.status') }}</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="seo_title" id="seo_title"
                                                value="{{ isset($movie->seo_title) ? stripslashes($movie->seo_title) : old('seo_title') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row" hidden>
                                    ...
                                    <div class="form-group row" hidden>
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <small id="emailHelp"
                                                class="form-text text-muted">{{ trans('words.seo_keyword_note') }}</small>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="video_image_thumb" id="video_image_thumb"
                                                    value="{{ isset($movie->video_image_thumb) ? $movie->video_image_thumb : null }}"
                                                    class="form-control" readonly>
                                                <div class="input-group-append">
                                                    <button type="button"
                                                        class="btn btn-dark waves-effect waves-light popup_selector"
                                                        data-input="video_image_thumb" data-preview="holder_thumb"
                                                        data-inputid="video_image_thumb">Select</button>
                                    ...
                                    @if (isset($movie->video_image_thumb))
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <img src="{{ URL::to('/' . $movie->video_image_thumb) }}"
                                                    alt="video thumb" class="img-thumbnail" width="110">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group row" id="display_thumb_img" style="display: none;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <img id="imdb_thumb_image" src="" alt="video thumb"
                                    ...
                                    {{-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="video_image" id="video_image"
                                                    value="{{ isset($movie->video_image) ? $movie->video_image : null }}"
                                                    class="form-control" readonly>
                                                <div class="input-group-append">
                                                    <button type="button"
                                                        class="btn btn-dark waves-effect waves-light popup_selector"
                                                        data-input="video_image" data-preview="holder_poster"
                                                        data-inputid="video_image">Select</button>
                                                </div>
                                            </div>
                                            <small id="emailHelp"
                                                class="form-text text-muted">({{ trans('words.recommended_resolution') }}
                                    ...
                                    @if (isset($movie->video_image))
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <img src="{{ URL::to('/' . $movie->video_image) }}" alt="video image"
                                                    class="img-thumbnail" width="160">
                                    ...
                                    <div class="form-group row" id="display_poster_img" style="display: none;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <img id="imdb_poster_image" src="" alt="video poster"
                                                class="img-thumbnail" width="160">
                                        </div>
                                    </div>
                                    ...
                                    {{-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="trailer_url" id="trailer_url"
                                                value="{{ isset($movie->trailer_url) ? stripslashes($movie->trailer_url) : old('trailer_url') }}"
                                                class="form-control">
                                        </div>
                                        <div class="col-sm-11">
                                            <small id="emailHelp" class="form-text text-muted">(Supported : MP4, YouTube,
                                                Vimeo, HLS / m3u8 URL. If you are using external files then those files have
                                                to be <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS"
                                                    target="_blank">CORS</a> enabled otherwise they will not
                                                work.)</small></label><br>
                                        </div>
                                    </div> --}}

                                    <div id="hide_when_upcoming"
                                        @if (isset($movie->upcoming) and $movie->upcoming == 1) style="display:none;" @endif>

                                        <div class="form-group row">
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.video_upload_type') }}</label>
                                            <div class="col-sm-8">
                                                <select class="form-control" name="video_type" id="video_type">
                                                    <option value="" selected disabled>Select video type</option>
                                                    @if (auth()->user()->user_type == 'Admin')
                                                        <option value="Local"
                                                            @if (isset($movie->video_type) and $movie->video_type == 'Local') selected @endif>Local
                                                        </option>
                                                    @endif
                                                    <option value="URL"
                                                        @if (isset($movie->video_type) and $movie->video_type == 'URL') selected @endif>URL</option>
                                                    <option value="HLS"
                                                        @if (isset($movie->video_type) and $movie->video_type == 'HLS') selected @endif>HLS/m3u8 /
                                                        MPEG-DASH / YouTube / Vimeo</option>
                                                    <option value="Embed"
                                                        @if (isset($movie->video_type) and $movie->video_type == 'Embed') selected @endif>Embed Code
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.video_quality') }}<small
                                                    id="emailHelp" class="form-text text-muted">(For Local and
                                                    URL)</small></label>
                                            <div class="col-sm-8">
                                                <div class="radio radio-success form-check-inline pl-2"
                                                    style="margin-top: 8px;">
                                                    <input type="radio" id="inlineRadio1" value="1"
                                                        name="video_quality"
                                                        @if (isset($movie->video_quality) && $movie->video_quality == 1) {{ 'checked' }} @endif>
                                                    <label for="inlineRadio1"> {{ trans('words.active') }} </label>
                                                </div>
                                                <div class="radio form-check-inline" style="margin-top: 8px;">
                                                    <input type="radio" id="inlineRadio2" value="0"
                                                        name="video_quality"
                                                        @if (isset($movie->video_quality) && $movie->video_quality == 0) {{ 'checked' }} @endif
                                                        {{ isset($movie->id) ? '' : 'checked' }}>
                                        ...
                                        <div class="form-group row" id="local_id" style="display:none;">
                                            {{-- @if (isset($movie->video_type) and $movie->video_type != 'Local') style="display:none;" @endif> --}}

                                            <div class="col-sm-11">
                                                <small id="emailHelp" class="form-text text-muted">(Supported :
                                                    MP4)</small></label><br>
                                            </div>


                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_file') }} *<small
                                                    id="emailHelp" class="form-text text-muted">(Defualt Player
                                                    File)</small></label>
                                            <div class="col-sm-8 mb-3">

                                                <div class="input-group">
                                                    <input type="text" name="video_url_local" id="video_url_local"
                                                        value="{{ isset($movie->video_url) ? $movie->video_url : null }}"
                                                        class="form-control" readonly>
                                                    <div class="input-group-append">
                                                        <button type="button"
                                                            class="btn btn-dark waves-effect waves-light popup_selector"
                                                            data-input="video_url_local"
                                                            data-inputid="video_url_local">Select</button>
                                                    </div>
                                                </div>
                                            ...
                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_file') }} 480P
                                                <small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">

                                                <div class="input-group">
                                                    <input type="text" name="video_url_local_480"
                                                        id="video_url_local_480"
                                                        value="{{ isset($movie->video_url_480) ? $movie->video_url_480 : null }}"
                                                        class="form-control" readonly>
                                                    <div class="input-group-append">
                                                        <button type="button"
                                                            class="btn btn-dark waves-effect waves-light popup_selector"
                                                            data-input="video_url_local_480"
                                                            data-inputid="video_url_local_480">Select</button>
                                                    </div>
                                                </div>

                                            </div>

                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_file') }} 720P
                                                <small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">

                                                <div class="input-group">
                                                    <input type="text" name="video_url_local_720"
                                                        id="video_url_local_720"
                                                        value="{{ isset($movie->video_url_720) ? $movie->video_url_720 : null }}"
                                                        class="form-control" readonly>
                                                    <div class="input-group-append">
                                                        <button type="button"
                                                            class="btn btn-dark waves-effect waves-light popup_selector"
                                                            data-input="video_url_local_720"
                                                            data-inputid="video_url_local_720">Select</button>
                                                    </div>
                                                </div>

                                            </div>

                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_file') }} 1080P
                                                <small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">

                                                <div class="input-group">
                                                    <input type="text" name="video_url_local_1080"
                                                        id="video_url_local_1080"
                                                        value="{{ isset($movie->video_url_1080) ? $movie->video_url_1080 : null }}"
                                                        class="form-control" readonly>
                                                    <div class="input-group-append">
                                                        <button type="button"
                                                            class="btn btn-dark waves-effect waves-light popup_selector"
                                                            data-input="video_url_local_1080"
                                                            data-inputid="video_url_local_1080">Select</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row" id="url_id"
                                            ...
                                            <div class="col-sm-11">
                                                <small id="emailHelp" class="form-text text-muted">(Supported : MP4 URL.
                                                    If you are using external files then those files have to be <a
                                                        href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS"
                                                        target="_blank">CORS</a> enabled otherwise they will not
                                                    work.)</small></label><br>
                                            </div>

                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_url') }} <small
                                                    id="emailHelp" class="form-text text-muted">(Defualt Player
                                                    File)</small></label>
                                            <div class="col-sm-8">
                                            ...
                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_url') }}
                                                480P<small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">
                                                <input type="text" name="video_url_480"
                                                    value="{{ isset($movie->video_url_480) ? $movie->video_url_480 : null }}"
                                                    class="form-control" placeholder="http://example.com/demo480.mp4">
                                            </div>

                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_url') }}
                                                720P<small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">
                                                <input type="text" name="video_url_720"
                                                    value="{{ isset($movie->video_url_720) ? $movie->video_url_720 : null }}"
                                                    class="form-control" placeholder="http://example.com/demo720.mp4">
                                            </div>

                                            <label class="col-sm-3 col-form-label">{{ trans('words.video_url') }}
                                                1080P<small id="emailHelp" class="form-text text-muted"></small></label>
                                            <div class="col-sm-8 mb-3">
                                                <input type="text" name="video_url_1080"
                                                    value="{{ isset($movie->video_url_1080) ? $movie->video_url_1080 : null }}"
                                                    class="form-control" placeholder="http://example.com/demo1080.mp4">
                                            </div>


                                        </div>

                                        <div class="form-group row" id="embed_id"
                                            @if (isset($movie->video_type) and $movie->video_type != 'Embed') style="display:none;" @endif
                                            @if (!isset($movie->id)) style="display:none;" @endif>
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.video_embed_code') }}</label>
                                            <div class="col-sm-8 mb-3">
                                                <textarea class="form-control" name="video_embed_code">{{ isset($movie->video_url) ? $movie->video_url : null }}</textarea>
                                            </div>
                                        </div>

                                        <div class="form-group row" id="hls_id"
                                            @if (isset($movie->video_type) and $movie->video_type != 'HLS') style="display:none;" @endif
                                            @if (!isset($movie->id)) style="display:none;" @endif>

                                            <div class="col-sm-11">
                                                <small id="emailHelp" class="form-text text-muted">(Supported : MP4,
                                                    YouTube, Vimeo, HLS / m3u8 URL. If you are using external files then
                                                    those files have to be <a
                                                        href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS"
                                                        target="_blank">CORS</a> enabled otherwise they will not
                                                    work.)</small></label><br>
                                            </div>
                                            ...
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.hls_streaming') }}</label>
                                            <div class="col-sm-8 mb-3">
                                                <input type="text" name="video_url_hls"
                                                    value="{{ isset($movie->video_url) ? $movie->video_url : null }}"
                                                    class="form-control" placeholder="http://example.com/test.m3u8">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="dash_id"
                                            @if (isset($movie->video_type) and $movie->video_type != 'DASH') style="display:none;" @endif
                                            @if (!isset($movie->id)) style="display:none;" @endif>
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.mpeg_dash_streaming') }}</label>
                                            <div class="col-sm-8 mb-3">
                                                <input type="text" name="video_url_dash"
                                                    value="{{ isset($movie->video_url) ? $movie->video_url : null }}"
                                                    class="form-control" placeholder="http://example.com/test.mpd">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" hidden>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="radio form-check-inline" style="margin-top: 8px;">
                                                    <input type="radio" id="inlineRadio4" value="0"
                                                        name="download_enable"
                                                        @if (isset($movie->download_enable) && $movie->download_enable == 0) {{ 'checked' }} @endif
                                                        {{ isset($movie->id) ? '' : 'checked' }}>
                                        ...
                                        <div class="form-group row" hidden>
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.download_url') }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="download_url" id="download_url"
                                                    value="{{ isset($movie->download_url) ? $movie->download_url : old('download_url') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <hr />
                                        <h4 class="m-t-0 m-b-15 header-title" style="font-size: 20px;">
                                            {{ trans('words.subtitles') }}</h4>
                                        <div class="col-sm-9 pl-0">
                                            <small id="emailHelp" class="form-text text-muted">(Supported : .srt or .vtt
                                                files URL only. If you are using external files then those files have to be
                                                <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS"
                                                    target="_blank">CORS</a> enabled otherwise they will not work.)</small>
                                        </div> <br />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="radio radio-success form-check-inline pl-2"
                                                    ...
                                                    <input type="radio" id="inlineRadio5" value="1"
                                                        name="subtitle_on_off"
                                                        @if (isset($movie->subtitle_on_off) && $movie->subtitle_on_off == 1) {{ 'checked' }} @endif>
                                                    <label for="inlineRadio5"> {{ trans('words.active') }} </label>
                                                </div>
                                                <div class="radio form-check-inline" style="margin-top: 8px;">
                                                    <input type="radio" id="inlineRadio6" value="0"
                                                        name="subtitle_on_off"
                                                        @if (isset($movie->subtitle_on_off) && $movie->subtitle_on_off == 0) {{ 'checked' }} @endif
                                                        {{ isset($movie->id) ? '' : 'checked' }}>
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.subtitle_language1') }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="subtitle_language1" id="subtitle_language1"
                                                    value="{{ isset($movie->subtitle_language1) ? $movie->subtitle_language1 : old('subtitle_language') }}"
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.subtitle_language2') }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="subtitle_language2" id="subtitle_language2"
                                                    value="{{ isset($movie->subtitle_language2) ? $movie->subtitle_language2 : old('subtitle_language2') }}"
                                                    placeholder="French" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-sm-3 col-form-label">{{ trans('words.subtitle_language3') }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="subtitle_language3" id="subtitle_language3"
                                                    value="{{ isset($movie->subtitle_language3) ? $movie->subtitle_language3 : old('subtitle_language3') }}"
                                                    placeholder="Spanish" class="form-control">
                                            </div>
                                        </div>
