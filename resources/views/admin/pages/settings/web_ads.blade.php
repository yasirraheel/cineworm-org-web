                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text text-center">
                                ...
                                <tbody>
                                    @foreach ($allAds as $api)
                                        <tr id="api_id_{{ $api->id }}">
                                            <td>{{ $api->id }}</td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <img src="{{ url($api->home_top) }}" alt="Banner Ad" style="width:728px; height:90px; display:block; margin: 0 auto;">
                                            </td>
                                            <td>
                                                <a href="{{ url('admin/web_ads_settings/delete/' . $api->id) }}"
                        ...
                        <nav class="paging_simple_numbers">
                            @include('admin.pagination', ['paginator' => $allAds])
                        </nav>
