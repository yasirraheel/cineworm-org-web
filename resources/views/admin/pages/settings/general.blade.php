...
@section('content')
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- site logo is starting from here --}}
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="site_meta_image" id="site_meta_image"
                                                    value="{{ isset($settings->site_meta_image) ? $settings->site_meta_image : null }}"
                                                    class="form-control" readonly>
                                                <div class="input-group-append">
                                                    <button type="button"
                                                        class="btn btn-dark waves-effect waves-light popup_selector"
                                                        data-input="site_meta_image" data-preview="holder_logo"
                                                        data-inputid="site_meta_image">Select</button>
                                                </div>
                                            </div>
                                            <small id="emailHelp"
                                                class="form-text text-muted">({{ trans('words.recommended_resolution') }} :
                                                180x50)</small>
                                            <div id="site_meta_image_holder" style="margin-top:5px;max-height:100px;"></div>
                                        </div>
                                    </div>

                                    @if (isset($settings->site_meta_image))
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">&nbsp;</label>
                                            <div class="col-sm-8">
                                                <img src="{{ URL::to('/' . $settings->site_meta_image) }}" alt="video image"
                                                    class="img-thumbnail" width="160">
                                            </div>
                                        </div>
                                    @endif
    ...
    <script type="text/javascript">
        ...
        function processSelectedFile(filePath, requestingField) {
            ...
            if (requestingField == "site_meta_image") {
                var target_preview = $('#site_meta_image_holder');
                target_preview.html('');
                target_preview.append(
                    $('<img>').css('height', '5rem').attr('src', elfinderUrl + filePath.replace(/\\/g, "/"))
                );
