              ...
              <div class="card-box">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row" id="live_url_id" @if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="HLS") style="display:none;" @endif>
                    ...
                    <label class="col-sm-3 col-form-label mt-4">{{trans('words.server_3_url')}}</label>
                     <div class="col-sm-8">
                    ...
                    <label class="col-sm-3 col-form-label mt-4">{{trans('Webpage Url')}}</label>
                     <div class="col-sm-8">
                      <input type="url" name="webpage_url" value="{{ isset($tv_info->webpage_url) ? $tv_info->webpage_url : old('channel_url3') }}" class="form-control">
                    </div>
                    <label class="col-sm-3 col-form-label mt-4">{{trans('Funding Url')}}</label>
                     <div class="col-sm-8">
                      <input type="url" name="donation_funding_url" value="{{ isset($tv_info->donation_funding_url) ? $tv_info->donation_funding_url : old('channel_url3') }}" class="form-control">
                    </div>
