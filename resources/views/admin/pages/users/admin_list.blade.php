          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/sub_admin/add_user')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2" data-toggle="tooltip" title="Add Moderator"><i class="fa fa-plus"></i> Add Moderator</a>
                </div>
              </div>
