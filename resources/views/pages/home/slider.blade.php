...
<div class="slider-area p-0">
    ...
    <div class="player-footer-section">
        @include('pages.home.player_footer')
    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                // Auto-scroll news ticker - GLOBAL FUNCTION
                window.initNewsTicker = function() {
                    // Find all ticker containers (mobile and desktop)
                    var tickers = document.querySelectorAll('.news-ticker-container');
                    if (tickers.length === 0) return;

                    tickers.forEach(function(ticker) {
                        // Prevent multiple initializations
                        if (ticker.getAttribute('data-initialized') === 'true') return;
                        ...
                        function startScrolling() {
                            ...
                            // Store timer to clear if needed (optional)
                            ticker.dataset.scrollTimer = scrollTimer;
                        }
